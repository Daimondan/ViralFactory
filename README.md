...
**Current engineering state (2026-07-25):** Batch-B P0-1, P0-3, P0-4, P1-5, and P1-8 are committed locally and the current full suite is **2543 passed, 2 skipped**. P0-2 remains intentionally blocked by `docs/decisions/DIVERGENCE-023-episode-format-guide-resolution.md`: episode media-plan routing needs a ratified generic Format Guide mapping, not a tenant-specific code path. P1-6 needs authorized music-source access plus operator approval of each asset. P1-7 has restored, live-verified RSS coverage but still needs a real generic query-ingestion runner. The next release proof is a fresh human-gated idea → approved assets → rendered MP4 walkthrough, followed by frame/audio inspection.
