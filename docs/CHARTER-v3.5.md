# ViralFactory Charter — v3.5

*The constitution of the system. Any AI or collaborator reads this before working on it.*
*v3.5 — 2026-07-11 — supersedes v3.4. Incorporates AMENDMENT-008 (`docs/decisions/AMENDMENT-008-final-output-compliance-loop.md`) — final-output compliance contract and bounded remediation loop on the Assembler side. All prior amendments (DIVERGENCE-001, DIVERGENCE-002, AMENDMENT-003, AMENDMENT-004, AMENDMENT-005, AMENDMENT-006, AMENDMENT-007, DIVERGENCE-008) remain in force. Repo location: `docs/CHARTER-v3.5.md`.*
