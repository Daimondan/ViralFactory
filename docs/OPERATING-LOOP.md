...
## Kickoff (once)
1. Operator loads the starter docs into the repo (README, BUILD_PLAN, charter, playbooks, UI direction, intake, this file) + empty `PROGRESS.md`.
2. Operator to Hermes: *"Read README.md, follow the builder reading order, then start BUILD_PLAN.md at T0.1 per its How-to-work rules."*
