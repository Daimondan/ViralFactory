...
2026-08-22 · VF-SR-1701 · Consumed the Story Room constitutional batch. Moved the manifest and architect note to `docs/inbox/processed/`, processed the pre-existing superseded BUILDER-NOTE-022 under its own history, and verified the effective v3.12/M17 pointers plus DIVERGENCE-017 supersession. · Q: VF-SR-1703 config-owned Story Room experiment boundary

2026-08-22 · VF-SR-1703 · Added tenant-scoped `story_room.enabled` and `story_room.default_mode` config with schema validation, canonical config hash, and explicit legacy compatibility provenance. StackPenni remains disabled/legacy; temporary enabled and disabled tenant fixtures pass with zero Python edits, and live `/` + `/ideas` retain legacy navigation with no automatic Story Room cutover. Focused/config regressions: 54 passed; live health HTTP 200. · Q: VF-SR-1704 additive Story Room storage contract

2026-08-22 · VF-SR-1704 · Added the tenant-scoped append-only Story Room ledger: stories, ordered events, typed contributions, artifact lineages/versions, hash-bound decisions, understanding entries, tool runs, and per-writer idempotency keys. Cross-tenant reads/writes fail closed; restart preserves history; retries are idempotent; app startup defensively initializes all tables. Focused storage/app-startup tests: 9 passed; full suite after the startup compatibility fix: 2644 passed, 2 skipped in 450.04s. · Q: VF-SR-1705 artifact version/lock/staleness service

2026-08-22 · VF-SR-1705 · Added strict Creative Brief, Idea Map, Story Map, exact-copy, and Asset Plan contracts; immutable monotonic versions; server-bound exact-hash locks; dependency registration with downstream-only staleness cascade; authoritative direct-edit versions with visible diffs; stale compile/lock rejection; and compare-and-set current-version enforcement. Focused artifact/storage tests: 14 passed; full suite: 2649 passed, 2 skipped in 457.88s. · Q: VF-SR-1706 Known/Assumed/Missing/Locked ledger

2026-08-22 · VF-SR-1706 · Added the evidence/authority service for Known, Assumed, Missing, and Locked entries. AI Known requires exact tenant/story-scoped event, contribution, or artifact evidence; Locked requires a verified server lock decision; human corrections supersede without deletion; idempotent retries preserve one entry. Focused understanding tests: 5 passed; full suite: 2654 passed, 2 skipped in 453.27s. · Q: VF-SR-1707 compatibility import and projections
...
2026-08-21 · VF-PROOF-1618 · Live walkthrough reached Home, Ideas, Treatments, Inspiration, Draft 106, Assets 35, and Results without approval/publish mutation. Proof remains open: requested 390px emulation reported `innerWidth=833`/`scrollWidth=833` instead of proving a true 390px layout; Asset 35 truthfully reports truncated VO and Needs re-render; Results exposes Buffer Instagram failure `shouldShareToFeed` missing; targeted treatment tests passed 14/14; full suite exceeded the tool timeout. Blocker tracked at GitHub issue #5. · Q: close these truthfulness/shared-backstage blockers and rerun the complete baseline
...
2026-07-30 · VF-FMT-1606 · Added a config-owned production-process registry and fail-closed resolver: standard remains standard, episode requires an approved registered process, approved ModuleStore module, valid schema, and exact version; dynamic module context is injected before Writer adapter work. Removed tenant episode hardcodes from active `prompts/views.yaml`; proposed process status prevents self-activation. Focused/integration tests: 115 passed. · Q: VF-FMT-1607 Operator-gated StackPenni episode entry

2026-07-30 · VF-FMT-1605 · Gate 1 now deep-copies the selected Format Guide binding into the approved treatment before Writer enqueue; missing metadata remains null, and the approved binding participates in the Writer-contract hash and full-contract integrity check. Focused/regression tests: 94 passed. · Q: VF-FMT-1606 Dynamic production resolver

2026-07-30 · VF-FMT-1604 · Added optional Format Guide `production_binding` validation, exact JSON-in-markdown round-trip, structured module-history metadata, deterministic proposal diffs, and operator gate rendering. Missing binding remains undeclared; it never defaults to episode. Focused tests: 7 passed; related regressions: 103 passed; full suite: 2545 passed, 2 skipped, 18 pre-existing/environmental failures (optional `python-docx`/`fal_client` imports and an existing tenant-string fixture). · Q: VF-FMT-1605 Gate-1 binding lock

2026-07-30 · VF-GOV-1603 · Reconciled M16 status between BUILD_PLAN and PROGRESS, updated the README repo map through AMENDMENT-019/DIVERGENCE-026, corrected the DIVERGENCE-022 map status, and marked the old “diversity is only in sources.yaml / do not touch the ideas prompt” instruction as superseded by AMENDMENT-019 in the source-diversity correction. · Q: VF-FMT-1604 Format Guide production binding

2026-07-30 · VF-GOV-1602 · Created `docs/CHARTER-v3.11.md`, preserving v3.10 for audit history. Incorporated AMENDMENT-015 and AMENDMENT-016, then AMENDMENT-017–019 in order; aligned README, CONTEXT, BUILD_PLAN, PROGRESS, and CHANGELOG current pointers. · Q: VF-GOV-1603 doc alignment audit
...
2026-07-25 · BATCH-B P1-8 · Word-level caption emphasis committed as `079871f`. Complete word timestamps produce a stable caption pill with the current word highlighted by config; incomplete timestamps retain static captions. Real FFmpeg overlay regression passed. Latest full suite: 2545 passed, 2 skipped. · Q: none
...
2026-07-25 · BATCH-B P1-5 · Episode compiler now applies Amendment-015 mechanical VO-led shot subdivision: `ceil(beat_duration_ms / 4000)`, exact beat coverage, per-shot render segments, stable beat blocks, and wide→medium→close→insert framing. Committed as `e42c572`; focused tests pass. · Q: P0-2 remains blocked pending generic Format Guide episode-routing ruling

2026-07-25 · BUILDER / Render state repair · 9 assets had completed render jobs with final MP4 files on disk but asset_state stuck at 'pending'. Fixed by updating state to 'rendered' for assets with completed assembly_render jobs or edit_plan status='rendered'. Force-failed stale job #75 (edit_plan for entity 18, running since Jul 20). 10 assets now at 'rendered' state (Gate 3 ready), 6 still pending (no final files), 1 approved, 8 killed. DB fix only — no code change needed, root cause is render service not updating asset_state after successful render (needs investigation) · Q: root cause of state-not-updating after render

2026-07-25 · BUILDER / Idea diversity fixes · Purged 10 active travel RSS sources from DB (Caribbean Journal travel articles IDs 3-12 set to status=killed — were polluting ideation with 80% off-topic content). Removed Reel bias from ideation prompt generate_v1.md (line 56: replaced 'prefer the Reel' with neutral format selection that actively counteracts format dominance). story-frameworks.md already deleted in prior commit. New idea generation test: 3 cards produced (2 Reel, 1 X Thread) — improvement from ~80% Reel dominance but still leans Reel · Q: add real RSS feeds for AI/wealth/entrepreneurship to sources.yaml

2026-07-25 · BUILDER / Cinematic realism direction · Operator chose cinematic painted realism over 2D flat vector. Character Bible v2.0: replaced flat vector Marlon/Gran'May/Dex with cinematic Fitzroy/Stackwell Pennifold. Visual Style Guide v2.0: stylization level 'cinematic_painted', generated supporting section updated for character-driven storytelling. Matches existing episode-format-parable.md + fal reference-conditioned pipeline (T11.4) + Layer-2 identity QC. Generated 3-second test videos in both styles for operator comparison · Q: ending card templates (title_card_v1, quote_card_v1) need design
...
2026-07-24 · BUILDER / Thread publish fix (DIVERGENCE-022 related) · Fixed thread publish path in buffer_adapter.py:232-237. Was sending `content` (internal summary line) to Buffer instead of the actual thread `posts` array. Now uses Buffer's thread API: `metadata.{service}.thread` array with each post as {text}, top-level `text` = first post. Platform → service key mapping via `_get_service_key()`: x/twitter→twitter, instagram→instagram, bluesky→bluesky, threads→threads, mastodon→mastodon. Frame objects (reel/story_series) NOT treated as text threads. 16 new tests pass · Q: none
...
2026-07-23 · VF-CW-009 · Component Workbench UI service. Added WorkbenchDataService (src/services/workbench_ui.py) that assembles workbench view data: candidates grouped by category and semantic role, plain-language state labels (no raw technical states), readiness summary per role/category, structured blockers for incomplete required roles, freeze-enabled flag only when all required categories have approved candidates. Falls back to format overrides from registry when no requirements saved. Optional roles with none_allowed don't block. No false greens (generating=imcomplete, failed=blocked). 10 new tests. 2193 passed, 2 skipped · Q: none

2026-07-23 · VF-CW-005 · Narration candidate sets. Added NarrationCandidateService (src/services/narration_candidates.py) that wraps VOGenerator and registers VO takes as workbench candidates in CandidateStore. Validates takes are complete (segments exist, paths exist, durations >0, text present); partial takes fail visibly. Computes spoken-text hash, timing hash, and artifact SHA-256. Beat refs derived from segment beat_ids. Failed generation registers a failed candidate so operator sees the failure. New take never inherits approval — regeneration supersedes prior. Approved take is the only one eligible for manifest freeze. 9 new tests with real WAV fixtures. 2183 passed, 2 skipped · Q: none

2026-07-23 · VF-RA SPIKE / REFERENCE RECREATION · Recreated an operator-supplied 8.9-second 1080×1920 reference through Shotstack sandbox and Creatomate from one frozen component set/spec hash, then downloaded, hashed, ffprobed, measured, frame-compared, visually inspected, and assembled a local labeled three-way review video. Both preserved caption alpha/timing, framing, color, and -15.3 LUFS soundtrack without content drift. Shotstack returned exact 540×960 in 12.67s with sandbox watermark; explicit `output.mute: false` had silently removed all audio until the field was omitted. Creatomate returned clean/no-watermark output in 7.64s but enforced 270×480 from a 1080×1920 logical canvas at both requested scales, with two byte-identical outputs; estimate one credit per actual render, API Log authoritative. No provider selected: fixture is provider-labeled, uses a baked caption PNG/continuous clip, and does not replace the blind normal/adversarial/native-caption/multi-tenant gate · Q: paid/unwatermarked exact-resolution and full VF-RA-003 capabilities remain open
2026-07-23 · VF-RA SPIKE / SHOTSTACK SANDBOX · Operator confirmed the supplied credential was sandbox-only; one call used the stage endpoint with no AI assets or production credits. Shotstack returned plan `sandbox`, rendered and downloaded an exact 540×960, 24 fps, five-second H.264 portrait artifact, and preserved the intended cream/orange centered Montserrat card. The expected sandbox watermark appeared top-left. An unrequested AAC stream was present but measured as digital silence (-91 dB), so stream presence is not audio evidence. Exact-size transport is proven; full quality/provider selection remains open · Q: run frozen normal/adversarial fixtures only after RendererSpec and manifest prerequisites
2026-07-23 · VF-RA SPIKE / CREATOMATE SMOKE · Operator-authorized direct RenderScript call succeeded without a template and produced a downloaded, hashed five-second portrait H.264 artifact. A first edge-blocked HTTP 403 created no render; two subsequent successful jobs were used to diagnose scaling and are expected to consume one credit each. Both provider responses forced `render_scale: 0.5` and returned 270×480 even when the 540×960 payload explicitly requested scale 1; visual inspection also suggested a sans-serif fallback for requested Georgia. No watermark was visible. Direct transport is proven, but further paid renders are paused until scale/font behavior is explained. Expected trial reserve is now 15 credits; Creatomate API Log is authoritative · Q: determine account/project scale and supported-font behavior before the next paid stage
2026-07-22 · ARCHITECT / DIVERGENCE-019 · Assembly-quality and official API review ruled that ViralFactory should retain creative/approval semantics but stop treating custom FFmpeg/PIL as the sole production-quality finish layer. Vizard is rejected for canonical assembly because its documented API repurposes existing long-form video into clips rather than executing an exact approved multi-layer composition. Added provider-neutral RendererSpec v1 and VF-RA-001..004: local conformance adapter, identical frozen-fixture Creatomate/Shotstack bake-off, blind operator quality/operational selection, then durable production adapter with local download/hash/probe/evidence. Creatomate is the primary candidate; Shotstack is the second/fallback candidate; local FFmpeg remains executable fallback. Charter stays v3.9. Build order: VF-CW-001..010 → VF-RA-001..004 → VF-CW-011..012 · Q: production provider pending operator bake-off
2026-07-21 · ARCHITECT / AMENDMENT-013 · Runtime audit found a healthy service but an incomplete production state machine: card 59 / asset 18 stayed at soundtrack approval for 25 minutes, recent jobs repeatedly failed on missing visual/VO prerequisites, mutable inventory had no exact component approvals, first-child lookup broke multi-platform ownership, and Gate 3 API approval did not prove a current final artifact/manifest/evidence. Operator direction ratified as Charter v3.9: build a pre-assembly Component Workbench for narration, visuals, soundtrack, SFX/source sound, typography, graphics, and format roles; freeze exact approved versions into an immutable manifest; assemble only that manifest; preserve separate exact-artifact Gate 3. VF-CW-001..012 block VF-VS-516/702/703 · Q: DIVERGENCE-017 remains separately pending
2026-07-21 · QA-loop F-008 · Reel asset card on /create/assets/<draft_id> had no 'Generate voice-over' step — only the autonomous chain could produce VO. A Reel with no vo_segments (e.g. retried card in 'assembling') hit a 409: 'Reel has 6 spoken beats but only 0 VO segment(s)'. Added /api/assets/<id>/generate-vo endpoint (shared VOGenerator.generate_vo_per_frame), a Generate VO step (Step 1) in the Reel branch, and disabled Plan final cut with 'needs VO' tooltip until VO exists. Dynamic step numbering: VO → Visuals → Plan. 18 UI review-display + 74 cross-file tests pass · Q: none
2026-07-21 · QA-loop F-007 · Reel asset card on /create/assets/<draft_id> had no 'Generate visuals' step — only 'Plan final cut' — so a Reel with no captures and no generated_images (e.g. retried card stuck in 'assembling') 409'd with 'No usable visual media is available'. Added a Generate visuals step (Step 1) mirroring the non-reel branch, and disabled Plan final cut with a tooltip until visuals exist. 16 UI review-display tests pass · Q: none
2026-07-20 · VF-VS-514 · Replaced remote/fixed-filename mixing with immutable, content-addressed preview and finished mix versions built only from rights-valid hashed local artifacts and the measured approved VO. Mix sets bind source/rights/VO/config/timeline hashes; top pick plus three alternatives are playable and retain true providers; atomic switching validates the finished file; failed replacement preserves the prior active mix; retries reuse without overwrite. 37 focused and 1,971 full-suite tests pass · Q: VF-VS-515 unifies Gate 3 soundtrack UX and switching
2026-07-20 · VF-VS-513 · Replaced the rejected 80/20 score and popularity tiers with evidence-honest LLM ranking over rights-verified local artifacts only. Candidate payloads preserve exact metric/provider/region/rank/time, rights version/hash, artifact/preview IDs, and fit observations; metric scope must match the candidate; rationale claims cite existing fields; selection IDs are unique members; incompatible provider metrics cannot be compared. Real-adapter proof covers processing profile, prompt v2.0, provenance, and cache reuse. 134 focused and 1,966 full-suite tests pass · Q: VF-VS-514 persists immutable top-pick and alternative mixes
2026-07-20 · VF-VS-512 · Moved soundtrack-search judgment into schema-validated Soundtrack Planner v1.2; Python now only normalizes, deduplicates, caps, caches, and executes planner queries. Provider enablement, adapter, endpoint, env credential references, region, capabilities, limits, timeouts, TTL, and request budget are config-driven. Empty queries fail without an `instrumental` fallback, and tenant fixtures prove distinct provider execution without code changes. 65 focused and 1,956 full-suite tests pass · Q: VF-VS-513 makes ranking rights-valid and evidence-honest
...
**Current Phase:** Charter v3.12 is current and M17 Story Room implementation is active. The truthful legacy baseline and VF-SR-1701..1704 are complete: the constitutional batch is consumed, StackPenni remains config-disabled/legacy, and the tenant-scoped append-only Story Room ledger exists with full-suite proof. VF-SR-1705 artifact versions, exact lock/reject decisions, dependency staleness, and authoritative direct edits is next; Desk/Story Room UI has not started. The legacy pipeline remains default/fallback; no destructive migration or navigation cutover is approved before the three-piece proof and operator gate. M14's Inspiration checkpoint, review-w8, review-episode-format, and M7 remain pending unless explicitly absorbed by later proof.
...
| 13. Visual + soundtrack pipeline | 🔧 | Rights/acquisition/mix components exist; VF-VS-515 is superseded and fresh VF-VS-516/702/703 proof is blocked by M15. |
| 14. Inspiration evidence workbench | 🔧 | VF-INSP-001..005 implemented; deep operator/architect checkpoint remains open. |
| 15. Pre-assembly Component Workbench + composition plan + render execution | ✅ | All 20 M15 tasks checked off + review-w9 P0/P1/P2 builder fixes applied. Composition route wired to CompositionPlanGenerator/PreviewGenerator. Navigation links added. Hardcoded values moved to config. DIVERGENCE-021 renumbered + conditions met. All UI defects fixed. |
| 16. Governance recovery, production bindings, editorial source-fit, and visual treatments | 🔧 | VF-GOV-1601..1603, VF-FMT-1604..1607, VF-IDEA-1608..1614, and VF-VIS-1615..1617 complete. VF-PROOF-1618 remains open on real live blockers and the full-suite timeout. |
| 17. Persistent Story Room conversational co-creation | ⬜ | AMENDMENT-020 design/build order filed. Begins after VF-PROOF-1618 yields a truthful legacy baseline; additive experiment only until three-piece proof + operator cutover. |
...
- [x] 2026-07-18: VF-VS-504 — Wired deterministic soundtrack-mix evidence into shared final compliance and Gate 3 readiness. Server-verified exact-plan approval is passed separately from untrusted plan JSON; renderer facts prove successful VO strategy execution; FFmpeg measures LUFS, dBTP, silence and audible windows; expected music/SFX IDs, event windows, source sound and VO-to-bed evidence fail closed when absent. Thresholds live in `config/soundtrack_review.yaml`. Proof: 14 focused tests with real FFmpeg media and shared `render_for_asset` coverage; full linked suite `1,875 passed, 7 skipped`. Non-VO soundtrack output remains blocked until the renderer produces exact source-bound mix evidence.
- [x] 2026-07-18: VF-VS-503 — Added the production soundtrack preview/decision gate. The asset UI presents the exact current persisted proposal and playable VO, bed-alone, bed-under-VO, source-sound, and representative-SFX evidence; approve and explicit VO-only remain locked until required previews are playable and acknowledged. Decisions are append-only, bind to the immutable plan hash, and use server-minted tokens. Reject, persisted-alternative replacement, and explicit VO-only create auditable outcomes; changed plans require fresh approval. Shared render blocks before FFmpeg, and the autonomous chain pauses as `awaiting_soundtrack_approval` rather than failing. Proof: 26 gate tests, actual FFmpeg mix generation, real Flask page/API and curl sequence, full linked-worktree suite `1,869 passed, 7 skipped`.
- [x] 2026-07-18: VF-VS-502 — Wired registered `soundtrack_plan_v1` into shared measured-VO edit planning after visual feasibility. The LLM receives the approved content contract, compiled VO timing, Writer audio intents, and assembled visual-style context. Mechanical validation blocks mismatched contracts, LLM-minted approval tokens, incomplete licence/reference data, malformed gain/timing fields, empty emotional register, and SFX beyond the VO timeline. Valid soundtrack and edit plans commit atomically with immutable hash linkage and persisted module provenance; a real-adapter test verifies input hash, prompt/version, model/provider, raw/validated output, verdict, temperature, and tenant provenance. Proof: 83 focused tests; full linked-worktree suite `1,854 passed, 7 skipped`.
- [x] 2026-07-18: VF-VS-501 — Added durable soundtrack-plan ownership before production invocation: Production Contract v2 now carries a typed nullable reference, and `PipelineStore` validates, canonical-hashes, append-only persists, and atomically links each saved soundtrack contract to its asset and Reel edit plan. Invalid/cross-asset plans fail before persistence; retries are idempotent and replacements create new immutable versions. Proof: 31 soundtrack tests, 130 focused contract/store tests, full linked-worktree suite `1,842 passed, 7 skipped`. LLM creation remains VF-VS-502.
- [x] 2026-07-18: VF-AU-401 — Closed the VO-led pre-render false-green boundary. Shared render now requires the complete persisted four-check feasibility result produced by edit planning; missing, partial, failed, or contradictory evidence returns `feasibility_required`, marks the plan `needs_operator_decision`, and never calls the renderer. Complete evidence reaches render. Proof: 40 boundary/related tests, full linked-worktree suite `1,835 passed, 7 skipped`, and read-only primary-DB verification classified the latest legacy VO-led plan blocked for missing evidence.
...
2026-07-19 · VF-VS-702 LIVE FIX · Card 41 exposed stale blocking capture UI: Gate 1 approval was hidden, upload counts falsely matched tasks by position, an image was generated for a voiceover requirement, and the legacy route swallowed provider failures. Restored non-blocking approval, capture access during production, fail-closed required-real-capture behavior, prompt v2.1/v1.1 capture boundaries, and Gate 1 state protection; 97 related tests + full suite 1,892 passed/7 skipped + real Card 41 read-only HTTP verification green · Q: detach invalid generated material #266 from Card 41 after deployment without deleting the preserved artifact
2026-07-20 · VF-INSP-001 · Added Inspiration evidence contracts (collection-run, trend-item, observation) with validation, URL+payload redaction, safe-payload hash, metric normalization (missing=unavailable never zero), and staleness. config/inspiration.yaml drives tenant-scoped providers, endpoints, regions, env-var credentials, TTLs, budgets, redaction, truthful section labels. 9 redacted fixtures cover chart/recommendation/empty/partial/malformed/rate-limited/auth-failed. 52 tests pass; no live network or credentials · Q: VF-INSP-002 collection store and adapters
2026-07-20 · VF-INSP-002 · Added InspirationStore (collection-run, trend-item, append-only observation tables) initialized by PipelineStore. Four provider adapters normalize Bundle.social IG audio + TikHub TikTok audio charts/video feed/IG reels into evidence contracts. Malformed responses fail visibly; missing creds fail closed; failed runs preserve prior data; secret URL params + payload fields stripped before DB; item identity deduped by (tenant, provider, native_id); observations append-only with movement history; first observation has no fabricated movement; tenant scoping isolates data. 22 focused tests pass; full suite 2045 passed, 2 skipped · Q: VF-INSP-003 read-only /inspiration UI
2026-07-20 · VF-INSP-003 · Added /inspiration read-only UI. Inspiration nav between Home and Pipeline. Server-rendered Flask + cream theme. Distinct Trending audio (chart) and Video inspiration (recommendation) sections with truthful labels. Platform/region filters. All C7 states (first-run/empty/stale/error/unavailable). Expandable long captions. Playable media only when safe preview exists; No preview otherwise. Missing metrics=unavailable not zero. No green success for failed/stale. First-observation disclaimer. No ideation/publish/download actions. Zero provider calls during render (instrumented test). 23 UI tests pass; full suite 2068 passed, 2 skipped · Q: VF-INSP-004 deployed live-provider proof
2026-07-20 · VF-INSP-004 · Live-provider proof: 3/4 providers collected successfully with real credentials (Bundle.social IG audio 25 items, TikHub TikTok Top 50/Viral 50 50 items each, TikHub TikTok video search 20 items). TikHub IG reels returns 400 (provider plan limitation) — page shows honest error state, prior data preserved. Updated TikHub endpoints to real API paths (changed since 2026-07-19 divergence). Adapters handle both fixture and live response shapes. Standalone live smoke script proves offline render. 9 pytest tests pass; full suite 2077 passed, 2 skipped · Q: VF-INSP-005 bookmark and promotion paths
2026-07-20 · VF-INSP-005 · Added 4 distinct promotion actions (Bookmark, Add to Source Bank, Propose experiment, Propose pattern) with append-only records, revert preserving history, bulk revert for queues >50, tenant scoping. Bookmark does not ground ideation; Source Bank creates status='new' candidate linked to observation provenance with Keep gate intact; experiment/pattern proposals enter async gate. No observation silently changes a module, process, source status, idea, or soundtrack. 5 API routes + UI buttons. 19 focused tests pass; full suite 2096 passed, 2 skipped · Q: M14 checkpoint — operator walkthrough + architect review
2026-07-22 · VISUAL+MUSIC · Replaced ffmpeg drawtext with PIL-rendered overlays (auto-wrap, rounded pill bg, Montserrat Bold + Anton fonts, brand color support). Added 8 new overlay styles to render_styles.yaml (emphasis, caption, proof, reframe, cta, bold-prosperity-gold, deep-ocean-teal, split-screen-coral-divider). Added rendering.font_path + font_display to models.yaml. Added /api/assets/<id>/soundtrack-discover route to run post-planner discovery against Bundle Social. Fixed planner search query guidance (rule 13: catalog-friendly terms). 11 overlay + 111 soundtrack + 18 render/config tests pass · Q: deploy and re-render asset 23
2026-07-25 · REPO HEALTH BATCH · Executed CORRECTION-repo-health-v1.0.md (12 items). P0-1: requirements reconstructed from live venv, 3 files with -r chaining, clean-venv install green. P0-2: transcription worker fresh-DB spam fixed (schema guarantee + exponential backoff). P0-3: atomic _claim() prevents two-worker race. P0-4: WAL + synchronous=NORMAL in create_app() and 3 entrypoints. P1-5: src/db.py factory created, pipeline.py migrated (51 sites). P1-6: encode tiers (CRF 16/20, 48kHz/256k, faststart on master). P1-7: caption sentence-boundary chunking + word timestamps from faster-whisper. P1-8: insightface installed, buffalo_l model fetched, identity QC now operational. P2-9: Shotstack/Creatomate removed from factory. P2-10: dangling process deleted + validate_process_registry() added. P2-11: reference assets moved from gitignored data/ to tracked assets/. P2-12: dead code deleted (AMENDMENT-007 parsers confirmed wired via produce_chain.py). Route parity holds. Full suite pending final run · Q: remaining P1-5 module migrations (app.py, production_orchestrator.py, materials.py, jobs.py), ffprobe on rendered master, full UI walkthrough, then blueprint split batch

2026-07-25 · BATCH-B P0-1 · Governance review gate now surfaces DRAFT/PROPOSED documents from both modules and reference assets, with individual auditable Approve/Reject/Park decisions and no silent application. Character bible is committed; full working-tree document audit captured. Focused tests 2 passed; full suite 2536 passed, 2 skipped. · Q: operator decision required for World Canon and Visual Style Amendment before the registry-anchored episode path may consume them

2026-07-25 · BATCH-B P0-2 · BLOCKED: filed DIVERGENCE-023 because no ratified generic Format Guide mapping identifies an episode format, its governing module, and approved reference authority. No StackPenni-specific route or DRAFT/PROPOSED-content bypass was added. · Q: architect ruling required

2026-07-25 · BATCH-B P0-3 · Process registry now fails startup on bidirectional prompt/input mismatch, including all 18 registered processes. Module views are validated through `prompts/views.yaml`; `media_plan_v2` declarations now match its ratified placeholder vocabulary. 23 registry/process-engine tests passed. · Q: none

2026-07-25 · BATCH-B P0-4 · Final audio mastering is now unconditional after VO/music/original-audio and optional SFX. It produces stereo 48 kHz AAC with loudnorm I=-14, TP=-1.5, LRA=11 and an alimiter ceiling. Real FFmpeg/ebur128 proof measured -14.0 LUFS; focused P0 tests 48 passed and full suite 2540 passed, 2 skipped. · Q: none
