...
2026-07-23 · DIVERGENCE-020 · Operator visual engagement criteria. 4-second max segment validator changed from advisory to blocking (segments >4s without early overlay rejected). Edit plan prompt v1.5→v1.6: 4s hard floor + supporting visuals, VO-only visual life, scene coherence. Visual Director prompt v1.1→v1.2: prefer video over stills, supporting graphics, scene coherence, 4s event splitting. Writer prompt: media mix guidance, caption emphasis, supporting visuals, VO-only visual life, scene coherence. 5 new tests. 2437 passed, 2 skipped · Q: none
...
**Current Phase:** Charter v3.9 ratified. M15 is the blocking production correction: VF-CW-001..010 establishes exact component candidates/decisions and immutable manifest; VF-RA-001..004 compiles a provider-neutral RendererSpec and selects Creatomate or Shotstack through a blind operator bake-off while preserving local FFmpeg fallback; VF-CW-011..012 completes manifest-only rendering, resumable per-platform orchestration, local evidence, and hardened Gate 3. VF-VS-515 is superseded; VF-VS-516/702/703 remain open until a genuinely fresh deployed Reel traverses the new path. M14 Inspiration implementation exists but its operator/architect checkpoint remains open. Existing review-w8, review-episode-format, and M7 checkpoints remain pending.
...
| 15. Pre-assembly Component Workbench + composition plan + render execution | ⬜ | AMENDMENT-013, AMENDMENT-014, and DIVERGENCE-019 govern; VF-CW-001..010 → VF-CP-001..004 → VF-RA-001..004 → VF-CW-011..012 is the active blocking work order. CompositionPlan and ratification sub-gate added between manifest freeze and render. Provider choice awaits blind Creatomate/Shotstack bake-off. |
