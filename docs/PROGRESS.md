...
2026-07-23 · VF-CW-001 · Behavioral baseline + correlated runtime evidence. Added 12 RED/GREEN fixtures proving 6 documented production defects (stuck soundtrack wait, done-job/missing-artifact mismatch, missing VO/manual-only recovery, first-child multi-platform selection, direct Gate 3 bypass, ambiguous newest edit plan) and 3 GREEN tests proving new job/step correlation columns. Added 7 correlation fields (business_slug, production_session_id, draft_id, asset_id, state, attempt, upstream_hash) to jobs table with idempotent migration, and 5 correlation fields to production_step_data. Existing DBs migrate transparently. 2118 passed, 2 skipped · Q: none
