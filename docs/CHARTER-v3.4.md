# ViralFactory Charter — v3.4

*The constitution of the system. Any AI or collaborator reads this before working on it.*
*v3.4 — 2026-07-04 — supersedes v3.3. Incorporates AMENDMENT-006 (`docs/decisions/AMENDMENT-006-writer-assembler-split.md`) — Writer/Assembler pipeline split + four-role nav, AMENDMENT-007 (`docs/decisions/AMENDMENT-007-writer-per-platform-assembler-media-only.md`) — Writer produces per-platform content, Assembler is media-only, AI review loop before Gate 2, and DIVERGENCE-008 (`docs/decisions/DIVERGENCE-008-postiz-to-buffer-swap.md`) — Postiz→Buffer swap. All prior amendments (DIVERGENCE-001, DIVERGENCE-002, AMENDMENT-003, AMENDMENT-004, AMENDMENT-005) remain in force. Repo location: `docs/CHARTER-v3.4.md`.*
...
- **The Writer produces all per-platform text; the Assembler does no text generation.** (AMENDMENT-007)
