...
**Verification:** 21 new tests cover: full coverage pass, gap/overlap/incomplete/out-of-bounds detection, no-events skip, measured-VO override, tolerance, talking-head short motion blocked (Draft 8 pattern), enough motion pass, cutaway pass, non-talking-head not checked, small shortfall tolerance, measured-VO for talking-head, runner integration, backward compat. 55 tests across feasibility + compliance suites green. Full suite pending.
