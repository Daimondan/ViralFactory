...
**Verification:** 18 new tests cover schema shape, enum matching with the contract, valid/invalid output validation, prompt file existence/version/tenant-string-free/provider-name-free/Assembler-side-boundary, registry entry presence/correct fields/playbook_type/not-retired/schema resolution/inputs. 39 tests across VF-VS-402 + process registry suites green. Full suite pending.
