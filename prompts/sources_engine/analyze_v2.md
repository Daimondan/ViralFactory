...
Analyze the seeds, transcript, materials, seed sources, and anti-examples, then produce a **Source Criteria** document as JSON. This document must be human-readable (the operator will review and edit it at the gate — never hidden weights).
...
- Mine the conversation transcript and materials for any source mentions the seed_sources list doesn't capture
