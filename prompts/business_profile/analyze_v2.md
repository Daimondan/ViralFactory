...
These are seeds the orchestrator extracted from the operator's conversation — the operator's actual phrasing, verbatim where possible. Mine them for business identity, brands, subjects, platforms, goals, and red lines.

{routed_seeds}

## Full conversation transcript

The complete onboarding conversation. Mine this for any business details the seeds don't capture.

{conversation_transcript}

## Uploaded materials

Content from files the operator uploaded (brand docs, strategy decks, etc.). Mine this for business details.

{materials_content}

## Your task

Analyze the seeds, transcript, and materials above and produce a structured business profile as JSON. The profile must capture:
...
- Extract ONLY what the operator said or what appears in their materials. Do not invent brands, subjects, or goals they didn't mention.
...
- The conversation transcript and materials are your PRIMARY sources. Mine them thoroughly.
